...
/**
 * <summary>
 * Constructs a full URL for the BusinessPhoneAppendJson API endpoint by combining the base URL
...
const buildUrl = (params, baseUrl) =>
    `${baseUrl}BusinessPhoneAppendJson?${querystring.stringify(params)}`;
...
/**
 * <summary>
 * Provides functionality to call the ServiceObjects PhoneAppend2 (PA2) API's BusinessPhoneAppendJson endpoint,
 ...
 * </summary>
 */
const BusinessPhoneAppendClient = {
    /**
     * <summary>
     * Asynchronously invokes the BusinessPhoneAppendJson API endpoint, attempting the primary endpoint
     ...
     * @param {string} PostalCode - The postal code of the business (e.g., "93101"). Optional.
     * @param {string} LicenseKey - Your license key to use the service.
     * @param {boolean} isLive - Value to determine whether to use the live or trial servers.
     * @param {number} timeoutSeconds - Timeout, in seconds, for the call to the service.
     * @returns {Promise<PA2Response>} - A promise that resolves to a PA2Response object.
     */
    async invokeAsync(BusinessName, Address, City, State, PostalCode, LicenseKey, isLive = true, timeoutSeconds = 15) {
        const params = {
            BusinessName,
            Address,
            City,
    ...
    /**
     * <summary>
     * Synchronously invokes the BusinessPhoneAppendJson API endpoint by wrapping the async call
     ...
     */
    invoke(BusinessName, Address, City, State, PostalCode, LicenseKey, isLive = true, timeoutSeconds = 15) {
        return (async () => await this.invokeAsync(
            BusinessName, Address, City, State, PostalCode, LicenseKey, isLive, timeoutSeconds
        ))();
    }
};

export { BusinessPhoneAppendClient, PA2Response };